...
var togetherai_1 = require("@langchain/community/chat_models/togetherai");
...
var modelWithJsonSchema = new togetherai_1.ChatTogetherAI({
    temperature: 0,
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prompt.pipe(modelWithJsonSchema).invoke({
